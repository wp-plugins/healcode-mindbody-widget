...
function hc_hmw_menu(){
    ...
    /* Adding Main Menu */
	add_menu_page('healcode-mb-widget', 'HC Widgets', 'manage_options', 'insert-html-short-manage','hc_hmw_snippets',plugins_url('healcode_mb_widget/images/hclogo.png'));
...
function hc_hmw_add_style_script(){
	...
	wp_register_script( 'hc_notice_script', plugins_url('healcode_mb_widget/js/notice.js') );
